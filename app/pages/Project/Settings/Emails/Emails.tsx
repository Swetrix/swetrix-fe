...
const ModalMessage = ({
  ...
  <div>
    ...
    <fieldset className='mt-4'>
      ...
      <div className={cx('mt-1 bg-white rounded-md -space-y-px dark:bg-[#191e2d]', { 'border-red-300 border': errors.reportFrequency })}>
        {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
      ...
      <td className='relative whitespace-nowrap py-4 text-right text-sm font-medium pr-2'>
        {isConfirmed ? (
          <div ref={openRef}>
            ...
            {open && (
              <ul className='text-left origin-top-right absolute z-10 right-0 mt-2 w-72 rounded-md shadow-lg bg-white dark:bg-[#191e2d] divide-y divide-gray-200 dark:divide-gray-700 focus:outline-none'>
