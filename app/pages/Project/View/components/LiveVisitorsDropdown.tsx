  ...
  return (
    ...
    >
      <p className='relative flex items-center h-5 text-gray-900 dark:text-gray-50 text-base cursor-pointer' onClick={() => setShow(!show)}>
        ...
        {show && (
          <div className='absolute z-10 mt-2 right-0 top-3 text-gray-900 bg-white border border-gray-200 rounded-md shadow-lg dark:bg-slate-900 dark:border-slate-700/50 min-w-max max-h-[200px] overflow-auto'>
