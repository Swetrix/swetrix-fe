...
export const CDN_URL = import.meta.env.REACT_APP_CDN_URL
...
export const isDevelopment = !import.meta.env.NODE_ENV || import.meta.env.NODE_ENV === 'development'
...
export const isSelfhosted = Boolean(import.meta.env.REACT_APP_SELFHOSTED)
