...
const Footer = ({ minimal, authenticated }) => {
  ...
  if (minimal) {
    return (
      <footer className='bg-gray-800 dark:bg-gray-900'>
        <div className='max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8 relative '>
  ...
  return (
    <footer className='bg-gray-800 dark:bg-[#181F29]' aria-labelledby='footer-heading'>
      ...
      <div className='w-11/12 mx-auto pt-8 pb-5 px-4 sm:px-6 lg:px-8 relative '>
